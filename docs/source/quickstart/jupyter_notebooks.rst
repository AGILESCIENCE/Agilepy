...
* science_api_tutorial: the most important ones. They show the basic usage of Agilepy to perform a scientific analysis for sources detection. The following notebook are useful example of the use of Agilepy: 
  ...
  * `VELA <../static/notebooks/VELA.html>`_: analysis of Vela region
  * `3C454.3 <../static/notebooks/3C4543.html>`_: analysis of November's 2010 gamma-ray flare of AGN 3C454.3. Reference paper: https://arxiv.org/pdf/1106.5162.pdf
  * `AITOFF <../static/notebooks/aitoff_maps.html>`_: how to produce a full sky AITOFF projection image.
