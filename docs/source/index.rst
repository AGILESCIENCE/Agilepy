...
In addition, Agilepy provides classes to analyse the AGILE scientific ratemeters, and a visibility interface to monitor the time evolution of the AGILE off-axis viewing angle for a chosen sky region, comparing them with Fermi/LAT off-axis evolution.
