...
mle:
  ...
  expratio_size: 10
    ...
    def displayLightCurve(self, filename, upperLine, lowerLine, saveImage=False):
        """It displays the Light curve generated by LightCurve function.

        Args:
            filename (str): The path of the Lightcurve text file
            upperLine (int): y for line1
            lowerLine (int): y for line2
