...
mle:
  ...
  expratio_size: 10
    ...
    def displayLightCurve(self, filename=None, lineValue=None, lineError=None, saveImage=False):
        ...
        Args:
            ...
            saveImage (bool, optional): if True the plot will be written on file. It defaults to False.
