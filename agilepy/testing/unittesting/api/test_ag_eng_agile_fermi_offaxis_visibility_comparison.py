...
class TestAGEngAgileFermiOffAxisVisibilityComparison:
    ...
    def test_ap_offaxis_comparation_tt(self, data_dir, log_dir, conf):
        ...
        ageng.apOffaxisComparation(str(ap_agile), str(ap_fermi), tstart, tstop, path_offaxis, vertical_boxes_mjd=vertical_boxes_mjd, zmax=zmax, timetype="TT", data_column_name=data_column_name, time_range=time_range, trigger_time_tt=trigger_time_tt, add_rm=add_rm, rm_files=rm_files, rm_labels=rm_labels)        
