...
#            ax.plot(meantimes[separations < zmax], separations[separations < zmax], '-r')
    ...
    def plotBayesianBlocks(self, data, plotTDelta=True, plotYErr=True, edgePoints=True, dataCells=True, meanBlocks=True, sumBlocks=False, plotRate=False, saveImage=False):
        """
        ...
        shape_dc = []
        if dataCells:
            for data_cell in data_in['data_cells']:
                sh = fig.add_shape(
                    type='line',
        ...
        if plotRate:
            ...
            trace4 = go.Scatter(x=data_in['data_cells'],
                                y=rateblocks,
                                mode='lines',
    ...
    def plotBayesianBlocksUnbinned(self, data, plotTDelta=True, plotYErr=True, edgePoints=True, dataCells=True, meanBlocks=True, sumBlocks=False, plotRate=False, saveImage=False):
        """
        Plot the results of the Bayesian Blocks analysis for unbinned data.
